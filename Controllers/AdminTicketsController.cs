...
namespace Helpful_Hackers._XBCAD7319._POE.Controllers
{
    public class AdminTicketsController : Controller
    {
        ...
        public AdminTicketsController(TicketDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Category,DateTicket,Description")] Ticket ticket)
        {
            if (ModelState.IsValid)
            {
                ...
                using (SmtpClient smtpClient = new SmtpClient())
                {
                    ...
                    mailMessage.Subject = "Ticket Response";
                    mailMessage.Body = $"Thank you for creating a ticket, here's our response. \nTicket Details Made: \nName: {ticket.Name}\nDate Issued: {ticket.DateTicket}\nResponse: {ticket.Description}";
